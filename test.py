...
import sys #La librería sys permite recibir desde python parámetros enviados desde la consola
...
# comando por cmd
# python test.py "ml_model/model_config2.json" "ml_model/pets_xception_transferlearning2.h5" "Data/feli.jpeg"